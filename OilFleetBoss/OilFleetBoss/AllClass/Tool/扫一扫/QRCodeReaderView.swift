...
//MARK: ---条形码扫描的时候添加中间的红线
    func addRedLineWithBarCodeScan() {
        if self.redLine == nil {
            ...
            self.redLine?.backgroundColor = homeColor()
...
//MARK: ---设置扫描区域的线框
    func setScanZoneLineBorder(_ scanRect : CGRect) {
        ...
        leftTopLayer.strokeColor = homeColor().cgColor
        ...
        rightTopLayer.strokeColor = homeColor().cgColor
        ...
        leftBottomLayer.strokeColor = homeColor().cgColor
        ...
        rightBottomLayer.strokeColor = homeColor().cgColor
